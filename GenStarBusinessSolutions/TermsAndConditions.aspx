<%@ Page Title="GenStar | Terms and Conditions" Language="C#" MasterPageFile="~/GenStarMaster.Master" AutoEventWireup="true" CodeBehind="TermsAndConditions.aspx.cs" Inherits="GenStarBusinessSolutions.TermsAndConditions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="padding-left:20px; padding-right:20px; padding-top:100px;">
    <div class="effect8" style="padding-left:20px; padding-right:20px; padding-top:20px; padding-bottom:20px;">
    <div class="AboutTextArea">
        <div id='ppHeader'>www.genstar.co.in Terms & Conditions</div>
        <div id='ppBody'>
            ...
            <br/>
            Provide us with feedback on our products or services Contacting us <span id='infoUs'></span>
            <br/>
        ...
        <div class='innerText'>www.genstar.com</div>
        <div class='innerText'>Test Address</div>
        Kolkata, Wet Bengal 700102
        <div class='innerText'>India</div>
        <div class='innerText'>test@test.com</div>
        <div class='innerText'>
            <br/>
